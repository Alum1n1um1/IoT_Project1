...
- **Score de Sécurité** : Évaluation globale de vulnérabilité basée sur la criticité des appareils
- **Actualisation des Données** : Fonctionnalité d'actualisation manuelle pour mettre à jour les données
...
- **Base de Données** : PostgreSQL avec authentification et gestion des caméras
